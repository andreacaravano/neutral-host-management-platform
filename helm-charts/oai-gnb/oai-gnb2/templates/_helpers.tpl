...
Common labels
*/}}
{{- define "oai-gnb2.labels" -}}
helm.sh/chart: {{ include "oai-gnb2.chart" . }}
{{ include "oai-gnb2.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "oai-gnb2.selectorLabels" -}}
app.kubernetes.io/name: {{ include "oai-gnb2.name" . }}
...
*/}}
{{- define "oai-gnb2.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "oai-gnb2.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
...
*/}}
{{- define "oai-gnb2.countDefaultRouteInterfaces" -}}
{{- $count := 0 -}}
